...
template <> constexpr inline auto noticemanager::qt_create_metaobjectdata<qt_meta_tag_ZN13noticemanagerE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "noticemanager",
        "on_btnAddNotice_clicked",
        "",
        "on_btnDeleteNotice_clicked",
        "on_btnRefresh_clicked",
        "on_btnBack_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btnAddNotice_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnDeleteNotice_clicked'
...
void noticemanager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_btnAddNotice_clicked(); break;
        case 1: _t->on_btnDeleteNotice_clicked(); break;
